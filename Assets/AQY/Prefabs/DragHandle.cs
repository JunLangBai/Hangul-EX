...
public class DragHandle : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Debug.Log(
            $"[DragHandle] Awake: panelActive={panelCanvasGroup.gameObject.activeSelf}, alpha={panelCanvasGroup.alpha}, isShown={isShown}");
    }

    private void TogglePanel()
    {
        Debug.Log(
            $"[DragHandle] TogglePanel called. isShown={isShown}, panelActive={panelCanvasGroup.gameObject.activeSelf}, alpha={panelCanvasGroup.alpha}");
